...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-06-25 05:36`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b065cc60-d10a-4985-8b93-fce0c3512ba2.git
$ cd b065cc60-d10a-4985-8b93-fce0c3512ba2
```
